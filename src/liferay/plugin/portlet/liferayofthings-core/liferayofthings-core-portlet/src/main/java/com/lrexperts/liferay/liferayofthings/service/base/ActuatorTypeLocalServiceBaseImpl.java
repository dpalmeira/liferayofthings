...
import com.lrexperts.liferay.liferayofthings.service.ActuatorTypeLocalService;
...
/**
 * Provides the base implementation for the actuator type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lrexperts.liferay.liferayofthings.service.impl.ActuatorTypeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ActuatorTypeLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ActuatorTypeLocalService,
        IdentifiableBean {
    ...
    private ActuatorTypeLocalServiceClpInvoker _clpInvoker = new ActuatorTypeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.lrexperts.liferay.liferayofthings.service.ActuatorTypeLocalServiceUtil} to access the actuator type local service.
     */
    ...
    public ActuatorType addActuatorType(ActuatorType actuatorType)
        ...
        return actuatorTypePersistence.update(actuatorType);
    }
     ...
     */
    @Override
    public ActuatorType createActuatorType(long actuatorTypeId) {
        return actuatorTypePersistence.create(actuatorTypeId);
    }
    ...
    @Override
    public ActuatorType deleteActuatorType(long actuatorTypeId)
        throws PortalException, SystemException {
        return actuatorTypePersistence.remove(actuatorTypeId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ActuatorType deleteActuatorType(ActuatorType actuatorType)
        throws SystemException {
        return actuatorTypePersistence.remove(actuatorType);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ActuatorType.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return actuatorTypePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return actuatorTypePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ActuatorType fetchActuatorType(long actuatorTypeId)
        throws SystemException {
        return actuatorTypePersistence.fetchByPrimaryKey(actuatorTypeId);
    }
     ...
     */
    @Override
    public ActuatorType fetchActuatorTypeByUuidAndCompanyId(String uuid,
        long companyId) throws SystemException {
        return actuatorTypePersistence.fetchByUuid_C_First(uuid, companyId, null);
    }
     ...
     */
    @Override
    public ActuatorType fetchActuatorTypeByUuidAndGroupId(String uuid,
        long groupId) throws SystemException {
        return actuatorTypePersistence.fetchByUUID_G(uuid, groupId);
    }
     ...
     */
    @Override
    public ActuatorType getActuatorType(long actuatorTypeId)
        throws PortalException, SystemException {
        return actuatorTypePersistence.findByPrimaryKey(actuatorTypeId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return actuatorTypePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public ActuatorType getActuatorTypeByUuidAndCompanyId(String uuid,
        long companyId) throws PortalException, SystemException {
        return actuatorTypePersistence.findByUuid_C_First(uuid, companyId, null);
    }
     ...
     */
    @Override
    public ActuatorType getActuatorTypeByUuidAndGroupId(String uuid,
        long groupId) throws PortalException, SystemException {
        return actuatorTypePersistence.findByUUID_G(uuid, groupId);
    }
     ...
     */
    @Override
    public List<ActuatorType> getActuatorTypes(int start, int end)
        throws SystemException {
        return actuatorTypePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getActuatorTypesCount() throws SystemException {
        return actuatorTypePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ActuatorType updateActuatorType(ActuatorType actuatorType)
        throws SystemException {
        return actuatorTypePersistence.update(actuatorType);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.lrexperts.liferay.liferayofthings.model.ActuatorType",
            actuatorTypeLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = actuatorTypePersistence.getDataSource();
