...
import com.lrexperts.liferay.liferayofthings.service.SensorValueLocalService;
...
/**
 * Provides the base implementation for the sensor value local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lrexperts.liferay.liferayofthings.service.impl.SensorValueLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SensorValueLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements SensorValueLocalService,
        IdentifiableBean {
    ...
    private SensorValueLocalServiceClpInvoker _clpInvoker = new SensorValueLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.lrexperts.liferay.liferayofthings.service.SensorValueLocalServiceUtil} to access the sensor value local service.
     */
    ...
    @Override
    public SensorValue addSensorValue(SensorValue sensorValue)
        throws SystemException {
        sensorValue.setNew(true);

        return sensorValuePersistence.update(sensorValue);
    }
     ...
     */
    @Override
    public SensorValue createSensorValue(long sensorValueId) {
        return sensorValuePersistence.create(sensorValueId);
    }
    ...
    @Override
    public SensorValue deleteSensorValue(long sensorValueId)
        throws PortalException, SystemException {
        return sensorValuePersistence.remove(sensorValueId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public SensorValue deleteSensorValue(SensorValue sensorValue)
        throws SystemException {
        return sensorValuePersistence.remove(sensorValue);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(SensorValue.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return sensorValuePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return sensorValuePersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return sensorValuePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public SensorValue fetchSensorValue(long sensorValueId)
        throws SystemException {
        return sensorValuePersistence.fetchByPrimaryKey(sensorValueId);
    }
     ...
     */
    @Override
    public SensorValue fetchSensorValueByUuidAndCompanyId(String uuid,
        long companyId) throws SystemException {
        return sensorValuePersistence.fetchByUuid_C_First(uuid, companyId, null);
    }
     ...
     */
    @Override
    public SensorValue fetchSensorValueByUuidAndGroupId(String uuid,
        long groupId) throws SystemException {
        return sensorValuePersistence.fetchByUUID_G(uuid, groupId);
    }
     ...
     */
    @Override
    public SensorValue getSensorValue(long sensorValueId)
        throws PortalException, SystemException {
        return sensorValuePersistence.findByPrimaryKey(sensorValueId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return sensorValuePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public SensorValue getSensorValueByUuidAndCompanyId(String uuid,
        long companyId) throws PortalException, SystemException {
        return sensorValuePersistence.findByUuid_C_First(uuid, companyId, null);
    }
     ...
     */
    @Override
    public SensorValue getSensorValueByUuidAndGroupId(String uuid, long groupId)
        throws PortalException, SystemException {
        return sensorValuePersistence.findByUUID_G(uuid, groupId);
    }
     ...
     */
    @Override
    public List<SensorValue> getSensorValues(int start, int end)
        throws SystemException {
        return sensorValuePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getSensorValuesCount() throws SystemException {
        return sensorValuePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public SensorValue updateSensorValue(SensorValue sensorValue)
        throws SystemException {
        return sensorValuePersistence.update(sensorValue);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.lrexperts.liferay.liferayofthings.model.SensorValue",
            sensorValueLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = sensorValuePersistence.getDataSource();
