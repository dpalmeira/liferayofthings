package com.lrexperts.liferay.liferayofthings.portlet.pillreminderdisplay;
...
@Controller()
@RequestMapping("VIEW")
public class PillReminderDisplayController extends BasePortletController {

	private static final Log _log = LogFactory.getLog(PillReminderDisplayController.class);

	private static final String PORTLET_PAGE_URL = "portlet/pillreminderdisplay";
		...
		if (Validator.isNotNull(sensorEndpoint)) {
			...
			try {
				...
				if (sensor!=null) {
		            ...
		            modelMap.put(LRoTWebKeys.LROT_THING_PILL_TAKEN_GRAPH_DATA, sensorValueList);
				}
				else {
