...
import com.lrexperts.liferay.liferayofthings.service.ActuatorLocalService;
...
/**
 * Provides the base implementation for the actuator local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lrexperts.liferay.liferayofthings.service.impl.ActuatorLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ActuatorLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements ActuatorLocalService, IdentifiableBean {
    ...
    private ActuatorLocalServiceClpInvoker _clpInvoker = new ActuatorLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.lrexperts.liferay.liferayofthings.service.ActuatorLocalServiceUtil} to access the actuator local service.
     */
    ...
    @Override
    public Actuator addActuator(Actuator actuator) throws SystemException {
        actuator.setNew(true);

        return actuatorPersistence.update(actuator);
    }
     ...
     */
    @Override
    public Actuator createActuator(long actuatorId) {
        return actuatorPersistence.create(actuatorId);
    }
    ...
    @Override
    public Actuator deleteActuator(long actuatorId)
        throws PortalException, SystemException {
        return actuatorPersistence.remove(actuatorId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Actuator deleteActuator(Actuator actuator) throws SystemException {
        return actuatorPersistence.remove(actuator);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Actuator.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return actuatorPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return actuatorPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return actuatorPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return actuatorPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public Actuator fetchActuator(long actuatorId) throws SystemException {
        return actuatorPersistence.fetchByPrimaryKey(actuatorId);
    }
     ...
     */
    @Override
    public Actuator fetchActuatorByUuidAndCompanyId(String uuid, long companyId)
        throws SystemException {
        return actuatorPersistence.fetchByUuid_C_First(uuid, companyId, null);
    }
     ...
     */
    @Override
    public Actuator fetchActuatorByUuidAndGroupId(String uuid, long groupId)
        throws SystemException {
        return actuatorPersistence.fetchByUUID_G(uuid, groupId);
    }
     ...
     */
    @Override
    public Actuator getActuator(long actuatorId)
        throws PortalException, SystemException {
        return actuatorPersistence.findByPrimaryKey(actuatorId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return actuatorPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public Actuator getActuatorByUuidAndCompanyId(String uuid, long companyId)
        throws PortalException, SystemException {
        return actuatorPersistence.findByUuid_C_First(uuid, companyId, null);
    }
     ...
     */
    @Override
    public Actuator getActuatorByUuidAndGroupId(String uuid, long groupId)
        throws PortalException, SystemException {
        return actuatorPersistence.findByUUID_G(uuid, groupId);
    }
     ...
     */
    @Override
    public List<Actuator> getActuators(int start, int end)
        throws SystemException {
        return actuatorPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getActuatorsCount() throws SystemException {
        return actuatorPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Actuator updateActuator(Actuator actuator) throws SystemException {
        return actuatorPersistence.update(actuator);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.lrexperts.liferay.liferayofthings.model.Actuator",
            actuatorLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = actuatorPersistence.getDataSource();
