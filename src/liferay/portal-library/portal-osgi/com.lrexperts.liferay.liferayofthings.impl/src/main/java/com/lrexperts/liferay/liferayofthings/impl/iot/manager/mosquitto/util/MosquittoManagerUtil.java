...
import com.lrexperts.liferay.liferayofthings.impl.iot.manager.mosquitto.client.CustomMqttClient;
...
public class MosquittoManagerUtil {
	...
	public static void publishMessage(long companyId, long groupId, String topic, String message, int qos) throws MosquittoChannelException {
